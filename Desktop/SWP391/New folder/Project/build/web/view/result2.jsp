                ...
                <div class="wrap-table100">
                    <div style="font-size: 20px;">
                        <div class="abc">
                            ...
                            <br/></div>
                        <a class="btn btn-primary btn-lg" style="border-radius: 5px; background-color: #868e96;" href="result1">See biochemical record</a> 
                        <a class="btn btn-primary btn-lg" style="border-radius: 5px; float: right;" href="result">See final result</a>
                        <br/><br/>
                    </div>
