    ...
    <head>
        ...
        <script>
            function submitDelete(id) {
                var c = confirm("Are you sure to delete this result?");
                if (c) {
            ...
            <tbody>
                ...
                <c:forEach items="${requestScope.list}" var="l">
                    <tr class="active-row">
                        ...
                        <td>${l.date}</td>
                        <td>
                             <a href="update-rs?id=${l.id}" style="text-decoration: none; color: #000; text-transform: none; border: 1px solid black;">
                                Update
                            </a>&nbsp;
                            <a class="hover" onclick="submitDelete(${l.id})" style="text-decoration: none; color: #000; text-transform: none; border: 1px solid black;">
                                Remove
                            </a>&nbsp;                   
                        </td>
                    </tr>
